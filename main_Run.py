    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'D:\projects_todododd\Attendance Management System using Face Recognition\Attendance\Manually Attendance\"')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='grey80')
                cs = '"D:\projects_todododd\Attendance Management System using Face Recognition"' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"D:\projects_todododd\Attendance Management System using Face Recognition\Attendance\"')
